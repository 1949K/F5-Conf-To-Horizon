    ...
    for block in blocks:
        if block:
            ...
            if block.startswith('sys management-ip '):
                ...
                self_address_match = re.search(r'address ([\d.:/]+)', block)
    ...
    with open(txt_file_path, 'w') as txt_file:
        ...
        if vlan_data:
            ...
            for idx_vlan, row_vlan in vlan_df.iterrows():
                ...
                vlan_interfaces_name = re.search(r'([^\s]+) \{\n', row_vlan["vlan_interfaces"])
                vlan_interfaces_name = vlan_interfaces_name.group(1) if vlan_interfaces_name else ''
        ...
        if self_data:
            ...
            for idx, row_self in self_df.iterrows():
                ...
                if row_self["self_traffic_group"] == "traffic-group-1":
                    ...
                    txt_file.write(f'    virtual-ip {row_self["self_address"]}\n')
